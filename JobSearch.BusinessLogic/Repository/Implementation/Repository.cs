...
using JobSearch.BusinessLogic.Repository.Interface.UnitOfWork;
using JobSearch.BusinessLogic.Repository.Interface.DataContext;

#endregion

namespace JobSearch.BusinessLogic.Repository.Implementation
{
